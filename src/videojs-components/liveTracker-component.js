...
class LiveTrackerComponent extends Component {
    ...
    constructor(player, options) {
        ...
        if (videojs.browser.IE_VERSION && 'hidden' in document && 'visibilityState' in document) {
...
Component.registerComponent('LiveTrackerComponent', LiveTrackerComponent);
export default LiveTrackerComponent;
